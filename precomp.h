...
int def_compare(FILE *compfile, int level, int windowbits, int memlevel, int& decompressed_bytes_used);
...
void write_decompressed_data_io_buf(int byte_count, int decomp_bytes_total, bool in_memory, char* decompressed_file_name = tempfile1);
