...
set LIBLZMA=%LIBLZMA% common\vli_decoder.c check\check.c check\crc32_table.c check\crc32_x86.S
set LIBLZMA=%LIBLZMA% check\crc64_table.c check\crc64_x86.S check\sha256.c lz\lz_encoder.c
