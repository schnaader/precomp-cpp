...
#define GIF_STAMP_PCF "PGFVER"          /* First chars in file - Precomp GIF stamp.  */
...
typedef struct GifCodeStruct { // schnaader
    int GIFCodeIndex;
    int GIFCodeIndexGet;
    int GIFCodeSize;
    int* GIFCode;
...
typedef struct GifDiffStruct { // schnaader
    int GIFDiffIndex;
    int GIFDiffSize;
    int GIFCodeCount;
    unsigned char* GIFDiff;
} GifDiffStruct;
...
int EGifPutScreenDesc(GifFileType * GifFile,
                      ...
                      int GifBackGround, int GifPixelAspectRatio,
...
GifFileType *DGifOpen(void *userPtr, InputFunc readFunc);    /* new one
                                                             * (TVT) */
GifFileType *DGifOpenPCF(void *userPtr, InputFunc readFunc);    /* new one
                                                             * (TVT) */
int DGifGetScreenDesc(GifFileType * GifFile);
int DGifGetRecordType(GifFileType * GifFile, GifRecordType * GifType);
int DGifGetImageDesc(GifFileType * GifFile);
int DGifGetLine(GifFileType * GifFile, GifPixelType * GifLine, GifCodeStruct * gCode, int GifLineLen);
int DGifGetPixel(GifFileType * GifFile, GifCodeStruct * gCode, GifPixelType GifPixel);
